...
pluginTester({
  ...
  tests: [
    ...
    {
      title: 'it should add tests for action creators',
      fixture: '__fixtures__/with-describe-call.js',
      pluginOptions: { actionTypes: { doSomething: 'doSomething' } }
    },
    {
      title: 'it should complete tests for action creators',
