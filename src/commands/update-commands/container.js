...
const updateContainerChain = require('../../scaffolding/container/update/chain');

exports.command = 'container <name>';

exports.describe =
  'Update react redux container. Creates missing action types and action creators, creates missing reducer cases. Will create action types, actions and reducer if need be.';
